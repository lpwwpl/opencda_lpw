...
walker_goal_points = []
#-53.53, -81.09, 4.0
spawn_point = carla.Transform(carla.Location(x=-53.53,y=-81.09,z=0.5), carla.Rotation(yaw=0, pitch=0, roll=0))
walker_spawn_points.append(spawn_point)

#-84.3286,-118.611,3.95
spawn_point = carla.Transform(carla.Location(x=-84.3286,y=-118.611,z=0.5), carla.Rotation(yaw=0, pitch=0, roll=0))
walker_spawn_points.append(spawn_point)
