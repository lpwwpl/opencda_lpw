...
from opencda.scenariomanager.actorcontrols.actor_control import ActorControl
from opencda.scenariomanager.timer import GameTime
from opencda.tools.scenario_helper import detect_lane_obstacle
from opencda.tools.scenario_helper import generate_target_waypoint_list_multilane


import opencda.tools
...
class ChangeWeather(AtomicBehavior):
    ...
    Args:
        weather (opencda.scenariomanager.weather_sim.Weather): New weather settings.
        name (string): Name of the behavior.
            Defaults to 'UpdateWeather'.

    Attributes:
        _weather (opencda.scenariomanager.weather_sim.Weather): Weather settings.
    """
...
class ActorTransformSetterToOSCPosition(AtomicBehavior):
    ...
    def update(self):
        ...
        self._osc_transform = opencda.tools.openscenario_parser.OpenScenarioParser.convert_position_to_transform(
            self._osc_position)
