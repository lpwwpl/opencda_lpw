...
from opencda.scenariomanager.scenarioatomics.atomic_behaviors import calculate_distance
...
from opencda.tools.scenario_helper import get_distance_along_route
...
class InTriggerDistanceToOSCPosition(AtomicCondition):
    ...
    def update(self):
        ...
        osc_transform = opencda.tools.openscenario_parser.OpenScenarioParser.convert_position_to_transform(
            self._osc_position)
