...
from opencda.customize.ml_libs.deep_sort.utils.parser import get_config
from opencda.customize.ml_libs.deep_sort.deep_sort import DeepSort

cfg = get_config()
cfg.merge_from_file("./opencda/customize/ml_libs/deep_sort/configs/deep_sort.yaml")
