...
import opencda.scenariomanager.scenarioatomics.atomic_trigger_conditions as conditions
...
from opencda.scenariomanager.weather_sim import WeatherBehavior
from opencda.scenariomanager.scenarioatomics.atomic_behaviors import UpdateAllActorControls
...
class BasicScenario(object):
    ...
    def __init__(self, name, ego_vehicles, config, world,
        ...
        self.scenario = Scenario(behavior_seq, self.name, self.timeout, self.terminate_on_failure)
