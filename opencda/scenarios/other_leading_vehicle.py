...
from opencda.scenariomanager.scenarioatomics.atomic_trigger_conditions import (InTriggerDistanceToVehicle,
                                                                               DriveDistance)
from opencda.scenarios.basic_scenario import BasicScenario
from opencda.tools.scenario_helper import get_waypoint_in_distance
...
class OtherLeadingVehicle(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False,
        ...
        self._first_vehicle_location = 10 #35
    ...
    def _create_behavior(self):
        ...
        keep_velocity.add_child(InTriggerDistanceToVehicle(self.other_actors[0], self.ego_vehicles[0], 10))  # 55
