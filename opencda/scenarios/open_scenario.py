...
from opencda.scenariomanager.scenarioatomics.atomic_behaviors import ChangeWeather, ChangeRoadFriction
from opencda.scenariomanager.scenarioatomics.atomic_behaviors import ChangeActorControl, ChangeActorTargetSpeed
from opencda.scenariomanager.timer import GameTime
from opencda.scenarios.basic_scenario import BasicScenario
from opencda.tools.openscenario_parser import OpenScenarioParser
from opencda.tools.py_trees_port import Decorator, oneshot_behavior
...
class OpenScenario(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, config_file, debug_mode=False, timeout=300):
        """
